...
################################################################
# This is a generated script based on design: system_overlay
#
...
# source system_overlay_script.tcl
...
set design_name system_overlay
...
proc create_root_design { parentCell } {
  ...
  set dac0_clk_clk_p [ create_bd_port -dir I -type clk dac0_clk_clk_p ]
  set dac0_clk_clk_n [ create_bd_port -dir I -type clk dac0_clk_clk_n ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net axi_dma_dac_M_AXIS_MM2S [get_bd_intf_pins axi_dma_dac/M_AXIS_MM2S] [get_bd_intf_pins usp_rf_data_converter_0/s00_axis]
  connect_bd_intf_net -intf_net axi_dma_dac_M_AXI_MM2S1 [get_bd_intf_pins axi_dma_dac/M_AXI_MM2S] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_dma_dac/S_AXI_LITE] [get_bd_intf_pins axi_smc/M02_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins axis_tlast_gen_0/s_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  ...
  connect_bd_net -net Net  [get_bd_pins proc_sys_reset_adc/peripheral_aresetn] \
  [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net clk_wiz_0_locked  [get_bd_pins clk_wiz_0/locked] \
  [get_bd_pins proc_sys_reset_adc/dcm_locked]
  connect_bd_net -net dac0_clk_clk_n_1  [get_bd_ports dac0_clk_clk_n] \
  [get_bd_pins usp_rf_data_converter_0/dac0_clk_n]
  connect_bd_net -net dac0_clk_clk_p_1  [get_bd_ports dac0_clk_clk_p] \
  [get_bd_pins usp_rf_data_converter_0/dac0_clk_p]
  ...
  [get_bd_pins proc_sys_reset_adc/slowest_sync_clk]
  ...
  [get_bd_pins axis_tlast_gen_0/aclk] \
  ...
  [get_bd_pins axi_dma_dac/m_axi_mm2s_aclk] \
  [get_bd_pins axi_dma_dac/s_axi_lite_aclk] \
  ...
  [get_bd_pins proc_sys_reset_adc/ext_reset_in]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_dac/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  ...
  exclude_bd_addr_seg -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg]
  exclude_bd_addr_seg -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs axi_dma_dac/S_AXI_LITE/Reg]
  exclude_bd_addr_seg -offset 0xB0000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs usp_rf_data_converter_0/s_axi/Reg]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
