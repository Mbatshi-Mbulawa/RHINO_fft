...
#
# system_overlay_project.tcl: Tcl script for re-creating project 'RHINO_RFSoC_200MSPS'
#
# Generated by Vivado on Sun Mar 22 23:44:16 +0000 2026
...
#
# 1. This project restoration tcl script (system_overlay_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/MBATSHI/RHINO_RFSoC_200MSPS/RHINO_RFSoC_200MSPS.srcs/sources_1/new/axis_tlast_gen.v"
#    "C:/Users/MBATSHI/RHINO_RFSoC_200MSPS/RHINO_RFSoC_200MSPS.srcs/constrs_1/new/system_overlay.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../RHINO_RFSoC_200MSPS/RHINO_RFSoC_200MSPS.srcs/sources_1/new/axis_tlast_gen.v"]"\
 "[file normalize "$origin_dir/../RHINO_RFSoC_200MSPS/RHINO_RFSoC_200MSPS.srcs/constrs_1/new/system_overlay.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "RHINO_RFSoC_200MSPS"
...
set script_file "system_overlay_project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../RHINO_RFSoC_200MSPS"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../Downloads/rfsoc4x2_board_files/rfsoc4x2"]" -objects $obj
...
set_property -name "top" -value "system_overlay_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../RHINO_RFSoC_200MSPS/RHINO_RFSoC_200MSPS.srcs/constrs_1/new/system_overlay.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/system_overlay.xdc"
...
if { [get_files [list axis_tlast_gen.v]] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/MBATSHI/RHINO_RFSoC_200MSPS/RHINO_RFSoC_200MSPS.srcs/sources_1/new/axis_tlast_gen.v
}


# Proc to create BD system_overlay
proc cr_bd_system_overlay { parentCell } {
...
# End of cr_bd_system_overlay()

cr_bd_system_overlay ""
set_property REGISTERED_WITH_MANAGER "1" [get_files system_overlay.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files system_overlay.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list system_overlay.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../RHINO_RFSoC_200MSPS/RHINO_RFSoC_200MSPS.gen/sources_1/bd/system_overlay/hdl/system_overlay_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list system_overlay.bd]] -top]
